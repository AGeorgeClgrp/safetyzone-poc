...
{"summary":"Max 12 words: the single most urgent risk.","pattern_alerts":["Max 10 words per pattern — name the issue and event count only."],"regulatory_flags":[{"event_id":"...","flag":"Regulation, citation, deadline."}],"counts":{"immediate":0,"high":0,"medium":0,"routine":0},"queue":[{"event_id":"...","priority":"immediate|high|medium|routine","one_liner":"Why this priority."}],"top_3":[{"event_id":"...","narrative_analysis":"2 sentences.","contributing_factors_extracted":["factor"],"recommended_actions":["action 1","action 2","action 3"],"interview_targets":[{"role":"Title","why":"Reason."}],"rca_warranted":true,"rca_rationale":"One sentence.","regulatory_obligations":"Regulation and deadline."}]${policyField}}

Priority rules: immediate=death or sentinel=true; high=severe harm, PSSM escalation candidates; medium=moderate harm; routine=no_harm or mild. top_3=3 most critical events. All event_id must exactly match input IDs.${policyRule}`;
